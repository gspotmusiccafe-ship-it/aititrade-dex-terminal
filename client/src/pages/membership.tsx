...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Generate full-length songs from prompts", included: true },
      { text: "Access to the Aitify Music Production Team", included: true },
      { text: "Professional audio mastering", included: true },
      { text: "Music distribution to all platforms", included: true },
